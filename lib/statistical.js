...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StatisticalMethod = __webpack_require__(5);
	
	var _StatisticalMethod2 = _interopRequireDefault(_StatisticalMethod);
	...
	var Statistical = function () {
	    ...
	    _createClass(Statistical, [{
	        ...
	        key: 'methods',
	        get: function get() {
	            return _hook2.default.cache(new _StatisticalMethod2.default(), _cacheManager2.default);
	        }
	...
	var Perceptron = function () {
	    ...
	    _createClass(Perceptron, [{
	        ...
	        value: function predict(input) {
	            ...
	            var score = 0;
	            this._weights.map(function (weight, i) {
	        ...
	        value: function train(data) {
	            ...
	            var prediction = this.predict(data.in);
	
	            if (prediction !== data.out) {
	                (function () {
	                    var error = data.out - prediction;
	
	                    /* Adjust new weight */
	                    _this._weights = _this._weights.map(function (weight, i) {
	                        weight += _this._learningRate * error * data.in[i];
	                        return weight;
	                    });
	                    _this._bias += error;
	                })();
